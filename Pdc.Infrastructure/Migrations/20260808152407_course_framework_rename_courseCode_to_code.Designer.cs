...
namespace Pdc.Infrastructure.Migrations
{
    ...
    [Migration("20260808152407_course_framework_rename_courseCode_to_code")]
    partial class course_framework_rename_courseCode_to_code
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChangeableEntityCourseFrameworkEntity", b =>
                {
                    ...
                    b.Property<string>("CourseFrameworkEntityCode")
                        .HasColumnType("text");

                    b.HasKey("AssedElementsId", "CourseFrameworkEntityCode");

                    b.HasIndex("CourseFrameworkEntityCode");
            ...
            modelBuilder.Entity("CourseFrameworkEntityCourseFrameworkEntity", b =>
                {
                    ...
                    b.Property<string>("PrerequisitesCode")
                        .HasColumnType("text");

                    b.HasKey("CourseFrameworkEntityCode", "PrerequisitesCode");

                    b.HasIndex("PrerequisitesCode");
            ...
            modelBuilder.Entity("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkCompetencyEntity", b =>
                {
                    ...
                    b.Property<string>("CourseFrameworkCode")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("CourseFrameworkCode");
            ...
            modelBuilder.Entity("ChangeableEntityCourseFrameworkEntity", b =>
                {
                    ...
                    b.HasOne("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkEntity", null)
                        .WithMany()
                        .HasForeignKey("CourseFrameworkEntityCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CourseFrameworkEntityCourseFrameworkEntity", b =>
                {
                    ...
                    b.HasOne("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkEntity", null)
                        .WithMany()
                        .HasForeignKey("PrerequisitesCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkCompetencyEntity", b =>
                {
                    ...
                    b.HasOne("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkEntity", "CourseFramework")
                        ...
                        .HasForeignKey("CourseFrameworkCode");
            ...
            modelBuilder.Entity("Pdc.Infrastructure.Entities.CourseFramework.CourseFrameworkEntity", b =>
                {
                    ...
                    b.OwnsOne("Pdc.Domain.Models.Common.Weighting", "Weighting", b1 =>
                        {
                            b1.Property<string>("CourseFrameworkEntityCode")
                                .HasColumnType("text");
                            ...
                            b1.HasKey("CourseFrameworkEntityCode");
