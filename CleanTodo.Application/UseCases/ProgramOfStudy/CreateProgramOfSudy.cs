...
public class CreateProgramOfSudy : ICreateProgramOfStudyUseCase
{
    ...
    public async Task<ProgramOfStudyDTO> Execute(CreateProgramOfStudyDTO createProgramOfStudyDto)
    {
        ...
        var programOfStudy = _mapper.Map<ProgramOfStudy>(createProgramOfStudyDto);

        var savedProgramOfStudy = await _programOfStudyRespository.Add(programOfStudy);

        return _mapper.Map<ProgramOfStudyDTO>(createProgramOfStudyDto);
    }
}