...
<template>
  <div>
    <div :class="{ 'has-comment': hasComments, 'highlight': isHovered && hasComments, 'commentable': true }"
      @mouseenter="isHovered = true; scrollToComment()" @mouseleave="isHovered = false">
      <span class="add-comment-btn" @click="handleAddCommentClick"></span>
      <slot></slot>
      <Transition name="slide-fade">
        <div class="add-comment-form" v-show="showAddComment">
    ...
    <Teleport to="#comments-panel">
      <div class="comment" :class="{ 'highlight': isHovered }" v-if="hasComments" @mouseenter="isHovered = true"
        ...
        <div class="comment-entry" v-for="complementaryInformation of complementaryInformations"
