...
public interface ICompetencyRepository
{
    ...
    Task<MinisterialCompetency> UpdateUntrackedChangeable(MinisterialCompetency entity);
    Task<MinisterialCompetency> UpdateTrackedChangeable(MinisterialCompetency entity);
